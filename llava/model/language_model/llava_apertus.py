#    Copyright 2025 Naufal Suryanto
#
...
from transformers import AutoConfig, AutoModelForCausalLM, ApertusConfig, ApertusModel, ApertusForCausalLM
...
class LlavaApertusForCausalLM(ApertusForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaApertusConfig

    def __init__(self, config):
        ApertusForCausalLM.__init__(self, config)

        # configure default generation settings
        config.model_type = "llava_apertus"
        # config.rope_scaling = None

        self.model = LlavaApertusModel(config)
...
AutoConfig.register("llava_apertus", LlavaApertusConfig)
AutoModelForCausalLM.register(LlavaApertusConfig, LlavaApertusForCausalLM)
